...
use App\Components\EnvironmentDetails;
use App\Components\DirectoryFilter;
...
class UpdateManager {    
    ...
    public function update() {        
        ...
        foreach ($currentManifest["sharepilot"]["files"] as $currentFile) {
            ...
            if (!$fileExists) {
                ...
                $this->removeDeletedDirectory(dirname($currentFilePath), $logFile);
            }
        }
    ...
    private function removeDeletedDirectory($dir, $logFile) {
        if (is_dir($dir)) {
